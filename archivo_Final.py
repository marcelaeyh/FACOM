...
direccion="/home/marcela/Desktop/FACOM/png/temperatura_completo/anual/"
direccion2="/home/marcela/Desktop/FACOM/Estaciones/temperatura_información.csv"
direccion3="/home/marcela/Desktop/FACOM/png/temperatura_completo/diurno/"
tabla="temperatura"
t=analisis_variable(tabla, engt,direccion,direccion2,direccion3)
#------------------------#----------------------------#-----------------------#
def analisis_variable_unicoCOD(tabla,eng,direccion,direccion2,direccion3,cod):
    #creación de vectores
    titulos=["Codigo Estacion","Nombre de estacion","Municipio","Departamento", "Zona Hidrográfica","Latitud"
             ,"Longitud","Fecha Inicial","Fecha Final","Muestreo valores iniciales","Muestreo valores finales","Numerofilas y columnas",
             "Máximo","Mínimo","Promedio","Desviación Estándar","Mediana"]
    ...
    plt.ylabel(desS+" ("+unidades+")")
    plt.grid()
    plt.savefig(direccion3+'CMD'  + '_IDEAM-' + str(cod) +  '.png') 
    ...
    plt.ylabel(desS+" ("+unidades+")")
    plt.grid()
    plt.savefig(direccion+'CMA'  + '_IDEAM-' + str(cod)  + '.png')  
...
direccion="/home/marcela/Desktop/FACOM/png/temperatura_completo/"
direccion2="/home/marcela/Desktop/FACOM/Estaciones/prueba.csv"
direccion3="/home/marcela/Desktop/FACOM/png/temperatura_completo/"
tabla="temperatura"
#p=analisis_variable(tabla, engt,direccion,direccion2,direccion3)
cod= 21201580
p=analisis_variable_unicoCOD(tabla,engt,direccion,direccion2,direccion3,cod)
#------------------------#----------------------------#-----------------------#
#------------------------#----------------------------#-----------------------#
#------------------------#----------------------------#-----------------------#
#------------------------#----------------------------#-----------------------#